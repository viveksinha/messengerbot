...
/**
 * Class that represents a FaceBot bean which can communicate through the network.
 *
 * @author Donato
 * @date 08/ago/2016
 */
public class FaceBotNetworkAwareBean extends FaceBotBean {
     ...
     *
     * @param input the JSON data to send.
     */
     ...
     * Sends a request.
     *
     * @param post the request to send
     */
     ...
     *
     * @param pageToken the token to validate.
     ...
     */
    protected static boolean validate(FaceBotResponse response) {
    ...
    public static void processAndPostMessage(FaceBotResponse response) {
        if (response != null) {
